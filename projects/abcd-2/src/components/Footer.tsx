      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              />
              <span className="font-bold text-xl text-indigo-400">Codex Solutions</span>
            </div>
            <p className="text-gray-400 mb-6">
              Building innovative software solutions for businesses across industries since 2014.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#work" className="text-gray-400 hover:text-indigo-400 transition-colors">Portfolio</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Custom Software Development</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Mobile App Development</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Web Applications</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Cloud Solutions</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Cybersecurity</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Database Management</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>123 Tech Park Boulevard<br />San Francisco, CA 94107</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@codexsolutions.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-sm text-gray-400 hover:text-indigo-400">Sitemap</a>
          </div>
        </div>
